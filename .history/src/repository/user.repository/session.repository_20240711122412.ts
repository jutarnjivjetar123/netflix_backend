...
export default class SessionRepository {
  public static createNewSession(userToCreateSessionFor: User, expiresAt: Date = new Date(), initialIpAddress: string, userAgent: string = "", sessionData: string = null) {
    ...
    newSession.ipAddressOfSessionInitialization = 
