...
export default class UserRepository {
  public static async createNewUser(
    ...
    public static async createNewUserHash(userToCreateHashFor: User): Promise<UserHash> { 
        ...
        newUserHash.hash = await EncryptionHelpers.hashPassword(userToCreateHashFor.username);
        newUserHash.hashOwner = userToCreateHashFor;
        newUserHash.createdAt = new Date();
        const generateHashResult = await DatabaseConnection.getRepository(UserHash).save(newUserHash);
