...
export default class VerificationTokenRepository {
  public static async createNewVerificationTokenForSession(
    ...
    console.log(
      new Date() +
        " -> LOG::Success::VerificationTokenRepository::createNewVerificationTokenForSession::newVerificationTokenCreationResult::Successfully created new verification token with parameters: " +
        JSON.stringify({
          ...
          expiryTime: newVerificationToken.expiresAt,
        })
    );
