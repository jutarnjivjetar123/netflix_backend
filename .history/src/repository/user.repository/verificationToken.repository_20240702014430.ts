...
export default class VerificationTokenRepository { 
    ...
    public static async createNewVerificationToken(user: User, tokenType: string, expiryTime: Date = new Date(newVerificationToken.createdAt.getTime() + 1000 * 60 * 60 * 24)): Promise<UserVerificationToken | null> {
