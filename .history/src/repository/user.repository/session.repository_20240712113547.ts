  ...
  public static async setSessionExpiryTimeByUser(
    ...
    await DatabaseConnection.getRepository(UserSession)
      ...
      .then(() => {
        ...
        console.log("[LOG-DATA] - " + new Date() + " -> LOG::Error::SessionRepository::setSessionExpiryTimeByUser::Error updating session expiry time, UPDATE operation on session with ID: " + sessionToUpdate. )
      });
  }
}
