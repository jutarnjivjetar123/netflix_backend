...
export default class UserRepository {
  ...
  public static async getUserPhoneNumberByPhoneNumber(phoneNumber: string): Promise<UserPhoneNumber | null> {
    const userPhoneNumber = await DatabaseConnection.getRepository(UserPhoneNumber).findOne({
      where: {
        phoneNumber: phoneNumber,
      },
      relations: {
    ...
    console.log(
      ...
      (userPhoneNumber
        ? "UserPhoneNumber with phoneNumber: " + phoneNumber + " found"
         : "UserPhoneNumber with phoneNumber: " + phoneNumber + " not found")
    );
