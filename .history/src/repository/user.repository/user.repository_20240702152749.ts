...
export default class UserRepository {
  ...
  public static async getUserPasswordByUser(
    ...
    console.log(
      new Date() +
        " -> LOG::Info::UserRepository::getUserPasswordByUser::userPassword::" +
        (userPassword
          ? "User Password for user: " + passwordOwner.userID + " found"
          : "User Password for user: " + passwordOwner.userID + " not found")
    );
  }
}
