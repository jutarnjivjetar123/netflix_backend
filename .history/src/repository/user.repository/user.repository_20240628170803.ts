...
export default class UserRepository {
  ...
  public static async createUserByPhoneNumber(
    ...
    const newUserPhoneNumberCreationResult = await DatabaseConnection.getRepository(
      UserPhoneNumber
    ).save(newUserPhoneNumber);

    if (!newUserPhoneNumberCreationResult) {
      console.log(
        new Date() +
          " -> LOG::Error::UserRepository::createNewUserByPhoneNumber::newUserPhoneNumberCreationResult::Could not create new user email"
      );
      return null;
    }
