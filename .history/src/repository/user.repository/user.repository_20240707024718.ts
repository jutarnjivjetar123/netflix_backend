...
export default class UserRepository {
  ...
  public static async getUserByPhoneNumber(phoneNumber: string) {
    ...
    console.log(new Date() + " -> LOG::Info::UserRepository::getUserByPhoneNumber::searchResult::Database search for input parameters - " + JSON.stringify(
      "nationalNumber" parsedPhoneNumber.phoneNumber,
