...
export default class UserRepository {
  public static async createNewUser(
    ...
    if (!newUserCreationResult) {
      console.log(
         new Date() + " -LOG::Error::UserRepository::createNewUser::newUserCreationResult::Could not create new user"
      );
      return null;
    }
    ...
    console.log("LOG::SUCCESS:UserRepository::createNewUser::User created with, id: " + newUser.userID + ", email: " + newUserEmail.email + ", username: " + newUser.username);
  }
}
