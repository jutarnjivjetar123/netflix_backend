...
export default class UserRepository {
  ...
  public static async createNewUserPhoneNumber(phoneNumber: string, userToCreatePhoneNumberFor: User, countryCode: string = null,
    region: string = null) { 
    const newPhoneNumber = new UserPhoneNu();
    newPhoneNumber
    }
