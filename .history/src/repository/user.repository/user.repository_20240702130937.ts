...
export default class UserRepository {
  ...
  public static async getUserSaltByUser(saltOwner: User): Promise<UserHash | null> {
  ...
  public static async getUserPasswordByUser(passwordOwner: User): Promise<UserPassword | null> { 
    
    const userPassword = await DatabaseConnection.getRepository(UserPassword).findOne({
      where: {
