...
export default class UserRepository {
  ...
  public static async createUserHash(
    ...
    newUserHash.hash = await EncryptionHelpers.generateSalt();
    newUserHash.hashOwner = newHashOwner;
    newUserHash.createdAt = new Date();
    const hashCreationResult = await DatabaseConnection.getRepository(UserHash).save(newUserHash);
