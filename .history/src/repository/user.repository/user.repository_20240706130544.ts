...
export default class UserRepository {
  ...
  public static async createNewUserPhoneNumber(
    ...
    await DatabaseConnection.getRepository(UserPhoneNumber).save(newPhoneNumber).then(() => { 
      return new ReturnObjectHandler("Created new phone number object with phone number: " + newPhoneNumber.phoneNumber + " for user: " + newPhoneNumber.phoneNumberOwner)
