  ...
  public static async createNewUser(
    ...
    DatabaseConnection.initialize()
      .then(() => {
        console.log(
          new Date() +
            " -> LOG::Success::UserRepository::createNewUser::DatabaseConnection::Database is online"
        );
      })
      .catch(() => {
        console.log(
          new Date() +
            " -> LOG::Error::UserRepository::createNewUser::DatabaseConnection::Database not initialized"
        );
        return null;
      });
