...
export default class UserRepository {
  ...
  public static async getUserByPhoneNumber(phoneNumber: string) {
    ...
    console.log(
      new Date() +
      " -> LOG::Info::UserRepository::getUserByPhoneNumber::searchResult::Database search for input parameters - \n" + "Phone number: " + parsedPhoneNumber.phoneNumber + "\n" + "Country code: " + parsedPhoneNumber.countryCode + "\n" + "returned following results: " + searchResult;
