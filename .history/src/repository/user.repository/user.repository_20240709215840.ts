...
export default class UserRepository {
  ...
  public static async getPasswordByUser(findPasswordForUser: User) {
    ...
    console.log(new Date() + " -> LOG::Info::UserRepository::getPasswordByUser::searchResult::Database search result for user with ID: " + findPasswordForUser.userID + (searchResult ? " found password object" : ""))
  }
}
