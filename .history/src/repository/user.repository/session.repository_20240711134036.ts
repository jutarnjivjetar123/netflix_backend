...
export default class SessionRepository {
  ...
  public static async deleteSessionByUser(userToDeleteSessionFor: User) {
    ...
    if (!sessionToDelete.sessionID) {
      console.log("[LOG-DATA] - " + new Date() + " -> LOG::Info::SessionRepository::deleteSessionByUser::sessionToDelete::No current session for user with ID: " + userToDeleteSessionFor.userID + " was found, so ")
      return null;
    }
