...
class DevRouter {
  ...
  private checkIsValidPhoneNumber(req: express.Request, res: express.Response) { 
  ...
  private getUsersByPhoneNumber(req: express.Request, res: express.Response) { 
    const { phoneNumber } = req.body;
    const parsedPhoneNumber = PhoneNumberHelper.
  }
}
