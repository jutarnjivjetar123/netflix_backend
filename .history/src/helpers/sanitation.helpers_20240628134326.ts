...
export default class DataSanitation {
  ...
  public static sanitizeNONEmailDataWithHTMLAndSpecialCharactersRemovalAndLowercasing(
    inputData: string
  ): string {
  ...
  public static sanitizeNONEmailDataWithHTMLAndSpecialCharactersRemoval(
    inputString: string
  ): string {
