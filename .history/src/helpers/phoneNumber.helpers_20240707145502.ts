...
export class PhoneNumberHelper {
  ...
  public static parsePhoneNumberFromString(
    ...
    try {
      ...
      console.info(new Date() + " -> LOG::Info::PhoneNumberHelper::parsePhoneNumberFromString::parsedPhoneNumber::Parsed phone number from string: " + phoneNumber + " to PhoneNumber object with ")
