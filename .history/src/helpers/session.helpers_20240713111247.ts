    ...
    if (!(await SessionService.isSessionActiveForUser(
      userToSetSessionFor
        ...
        await SessionService.deleteSessionForUser_WithActiveSessionChecking(
          ...
          console.log("[LOG-DATA] - " + new Date() + " -> LOG::Error::SessionManager::setSessionForUser::deleteSessionForUser_WithActiveSessionChecking::TryCatch exception::Error occured whilst checking ")
        });
