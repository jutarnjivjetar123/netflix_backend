...
console.log("TEST EMAIL: " + "test.user+malicious@example.com <img src=x onerror=alert('XSS')>" + " sanitazion:" + DataSanitazion.e("test.user+malicious@example.com <img src=x onerror=alert('XSS')>"));
