...
export class PhoneNumberHelper {
  ...
  public static parsePhoneNumberFromString(
    ...
    try {
      ...
      console.error(new Date() + " -> LOG::ERROR::PhoneNumberHelper::parsePhoneNumberFromString::parsedPhoneNumber::Parsing phone number value: " + phoneNumber + " cause following error: ")
