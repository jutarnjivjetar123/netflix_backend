...
const testEmail = "test.<tag>HTML CODE IS NICE</tag>malicious@example.com <img src=x onerror=alert('XSS')>";

console.log("TEST EMAIL: " + testEmail + ", after HTML tags removal: " + DataSanitazion.replaceEscapedCharactersWithHTML)