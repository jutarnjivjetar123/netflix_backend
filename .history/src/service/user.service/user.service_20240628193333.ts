...
export default class UserService {
  ...
  public static async checkIfUserExistsWithPhoneNumber(phoneNumber: string, callingCode: string = null): Promise<boolean> { 
    ...
    if (userExists) {
      console.log(
        new Date() +
          " -> LOG::Info::UserService::checkIfUserExistWithPhoneNumber::userExists::Found existing user with phone number: " + "("+ callingCode ? callingCode : " no calling code" +")" +
          phoneNumber +
          ", username: " +
          userExists.username +
          ", ID: " +
