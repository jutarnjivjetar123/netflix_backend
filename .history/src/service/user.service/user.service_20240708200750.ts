...
export default class UserService {
  ...
  public static async checkDoesUserExistWithPhoneNumber(phoneNumber: string) {
    ...
    if (typeof parsedPhoneNumber === "string") {
      doesUserExist = await UserRepository.getUserByPhoneNumber(
        parsedPhoneNumber
      );
    }
    if (typeof parsedPhoneNumber !== "string") { 
      doesUserExist = await UserRepository.getUserByPhoneNumber(parsedPhoneNumber.getNationalNumber(), parsedPhoneNumber.getC)
    }
  }
