...
export default class UserService {
  public static async createAndValidateNewUser(
    ...
    try {
      ...
      throw new Error("Failed to add new user: error message: " + error);
    }
      
      let newUserHash: UserHash;

      try {
        
      } catch (error) {
          throw new Error("Failed to generate new user hash: error message: " + error;
      }
  }
}
