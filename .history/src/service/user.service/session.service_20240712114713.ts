...
export default class SessionService {
  ...
  public static async deleteSessionForUser_WithActiveSessionChecking(
    ...
    if (await this.isSessionActiveForUser(userToDeleteSessionFor)) { 
      console.log("[LOG-DATA] - " + new Date() + " -> LOG::Info::SessionService::deleteSessionForUser_WithActiveSessionChecking::Could not delete session for user with ID: " + userToDeleteSessionFor.userID + " because has an active session")
    }
  }
  ...
  public static async extendSessionLifespanByUser(
    ...
    return await SessionService.extendSessionLifespanByUser(
      sessionOwnedByUser,
