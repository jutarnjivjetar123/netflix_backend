...
export default class UserService {
  ...
  public static async loginUserWithEmail(email: string, password: string) {
    ...
    if (doesUserHaveActiveSession) { 
      ...
      console.log(new Date() + " -> LOG::Info::UserService::loginUserWithEmail::doesUserHaveActiveSession::User with ID: " + userToLogin.userID + " has an active session with ID: " + se)
    }
  }
}
