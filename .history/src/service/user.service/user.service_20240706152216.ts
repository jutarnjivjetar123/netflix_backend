...
export default class UserService {
  ...
  public static async createNewUserByPhoneNumber(
    ...
    if (newPhoneNumber.returnValue) { 
      return new ReturnObjectHandler("Could not create new phone number for user with ID: " + newUser.returnValue.userID + ", error: " + newPhoneNumber.message, newPhoneNumber.);
    }
  }
}
