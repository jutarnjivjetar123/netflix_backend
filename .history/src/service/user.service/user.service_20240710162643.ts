...
export default class UserService {
  ...
  public static async loginUserWithEmail(
    ...
    if (doesUserHaveActiveSession) {
      ...
      console.log(new Date() + " -> LOG::Info::UserService::loginUserWithEmail::doesUserHaveActiveSession::User with ID: " + userToLogin.userID + " has an active session, logging in user with session ID: " + sessio)
    }
    if (!doesUserHaveActiveSession) {
      sessionForUser = await SessionService.createNewSession(
        userToLogin,
