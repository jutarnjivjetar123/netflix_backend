...
export default class UserService {
  ...
  public static async createAndValidateNewUserByPhoneNumber(
    ...
    if (!PhoneNumberHelper.validatePhoneNumberFromPhoneNumberType(parsedPhoneNumber)) { 
      console.log(
        new Date() +
          " -> LOG::Error::UserService::createAndValidateNewUserByPhoneNumber::Not phone number::Missing required variables::Could not create new user"
      );
      return null;
    }
    password = DataSanitazion.removeAllWhitespaces(password);
