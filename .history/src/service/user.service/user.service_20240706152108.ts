...
export default class UserService {
  ...
  public static async createNewUserByPhoneNumber(
    ...
    const newPhoneNumber = await this.createNewUserPhoneObject(parsedPhoneNumber.phoneNumber, newUser.returnValue, parsedPhoneNumber.countryCode, parsedPhoneNumber. )
  }
}
