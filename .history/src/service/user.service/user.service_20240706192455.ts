...
export default class UserService {
  ...
  public static async checkDoesUserExistWithPhoneNumber(phoneNumber: string): Promise<ReturnObjectHandler<boolean>> { 
    if (validator.isMobilePhone(phoneNumber)) { 
      return new ReturnObjectHandler("Provided phone number cannot be considered valid");
    }
  }
