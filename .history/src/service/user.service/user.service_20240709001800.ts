...
export default class UserService {
  ...
  public static async registerUserWithPhoneNumber(
    ...
    return new ReturnObjectHandle("Successfully created new user using phone number, returning created data for objects User, UserPassword, UserPhoneNumber, UserSalt")
  }
}
