...
export default class UserService {
  public static async createAndValidateNewUser(
    ...
    const userHashCreationInTheDatabaseResult = await UserRepository.createUserHash(userCreationInTheDatabaseResult);
    ...
    console.log(
      new Date() +
        " -> LOG::Partial Success::UserService::createAndValidateNewUser::userHashCreationInTheDatabaseResult::Created a new hash for user: " + userCreationInTheDatabaseResult.username + " with value : " + userHashCreationInTheDatabaseResult. 
    );
