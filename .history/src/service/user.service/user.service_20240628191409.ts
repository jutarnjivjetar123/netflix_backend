...
export default class UserService {
  ...
  public static async createAndValidateNewUserByPhoneNumber(
    ...
    const userCreationInTheDatabaseResult = await UserRepository.createUserByPhoneNumber(
      phoneNumber, 
      password,
      firstName, 
      lastName,
    ...
    if (!userCreationInTheDatabaseResult) {
      console.log(
        new Date() +
          " -> LOG::Error::UserService::createAndValidateNewUserByPhoneNumber::userCreationInTheDatabaseResult::Could not create new user"
      );
      return null;
    }
