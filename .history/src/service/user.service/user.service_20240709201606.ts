...
export default class UserService {
  ...
  public static async checkDoesUserExistWithPhoneNumber_WithParsing(
    ...
    try {
      ...
      console.log(new Date() + " -> LOG::Info::UserService::checkDoesUserExistWithPhoneNumber_WithParsing::parsedPhoneNumber::Parsed phone number with type of " + typeof parsedPhoneNumber )
    } catch (error) {
      console.log(
        new Date() +
  ...
  private static async createNewUserByEmail(
    firstName: string,
    lastName: string,
    username: string
  ) {
  ...
  public static async registerUserByEmail(
    ...
    const userCreationResult = await this.createNewUserByEmail(
      username,
      firstName,
      lastName
    );
