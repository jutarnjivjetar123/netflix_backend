...
export default class UserService {
  public static async createAndValidateNewUser(
    ...
    username = DataSanitazion.sanitazeNonEmailData(username);
    email = DataSanitazion.sanitazeEmailData(email);
    password = DataSanitazion.sanitazeNonEmailData(password);
    firstName = !firstName ? firstName : DataSanitazion.sanitazeNonEmailData(firstName);
    lastName = !lastName ? lastName : DataSanitazion.sanitazeNonEmailData()
