...
export default class UserService {
  ...
  public static async registerUserWithPhoneNumber(
    ...
    console.log(new Date() + " -> LOG::Info::UserService::registerUserWithPhoneNumber::paramater values and types (output format variable: type = value):" +
      "\nfirstName: " + typeof firstName + " = " + firstName +
      "\nlastName: " + typeof firstName + " = " + firstName +
      "\nfirstName: " + typeof firstName + " = " + firstName +
      "\nfirstName: " + typeof firstName + " = " + firstName 
