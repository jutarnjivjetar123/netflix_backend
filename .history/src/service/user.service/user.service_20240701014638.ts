...
export default class UserService {
  ...
  public static async createAndValidateNewUserByPhoneNumber(
    ...
    const callingCode = PhoneNumberHelper.phoneNumberUtil.extractCountryCode(parsedPhoneNumber);
    phoneNumber =
      PhoneNumberHelper.convertPhoneNumberTypeToString(parsedPhoneNumber);
