...
export default class UserService {
  ...
  public static async loginUserWithEmail(
    ...
    if (doesUserHaveActiveSession) {
      const sessionForUser = SessionService.getActiveSessionByUser(userToLogin);
      ...
      console.log(new Date() + " -> LOG::Info::UserService::loginUserWithEmail::doesUserHaveActiveSession::User with ID: " + userToLogin.userID + " has an active session, logging in user with session ID: " + sessionForUser.)
    }
    if (!doesUserHaveActiveSession) {
      sessionForUser = await SessionService.createNewSession(
        userToLogin,
