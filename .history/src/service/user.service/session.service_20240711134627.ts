...
export default class SessionService {
  ...
  public static async deleteSessionForUser_WithActiveSessionChecking(userToDeleteSessionFor: User) { }
  public static async deleteSessionForUser_NOActiveSessionChecking(userToDeleteSessionFor: User) { }
