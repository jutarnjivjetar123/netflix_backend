...
export default class UserService {
  public static async createAndValidateNewUser(
    ...
    console.log(
      new Date() +
        " -> LOG::Success::UserService::createAndValidateNewUser::userCreationInTheDatabaseResult::Successfully created new user::New user data: ID: " + userCreationInTheDatabaseResult.
    );
    return null;
