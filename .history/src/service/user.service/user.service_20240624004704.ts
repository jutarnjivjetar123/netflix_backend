...
export default class UserService {
  public static async createAndValidateNewUser(
    ...
    console.log(
      new Date() +
      " -> LOG::Success::UserService::createAndValidateNewUser::userCreationInTheDatabaseResult::Successfully created new user::New user data: ID: " + userCreationInTheDatabaseResult.userID + " with username: " + userCreationInTheDatabaseResult.username + " and createdAt timestamp: " + userCreationInTheDatabaseResult.createdAt;
    );
    return null;
