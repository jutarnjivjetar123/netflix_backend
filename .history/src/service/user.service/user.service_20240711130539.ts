...
export default class UserService {
  ...
  public static async loginUserWithEmail(
    ...
    if (!createdSession) {
      console.log("[LOG-DATA] - " + new Date() + " -> LOG::Error::UserService::loginUserWithEmail::createdSession::SessionService returned null, could not login user successfully, check ")
