...
export default class UserService {
  ...
  public static async registerUserWithPhoneNumber(
    ...
    //Parse phone number input, get either only phone number (nationalPhoneNumber has value of parsedPhoneNumber, countryCode has value of null), or national phone number with country code (nationalPhoneNumber has value of parsedPhoneNumber object type of libphonenumber.PhoneNumber with )
    let parsedPhoneNumber;
