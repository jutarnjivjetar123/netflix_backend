...
export default class UserService {
  public static async checkDoesUserExistWithEmail(
    ...
    if (databaseSearchResult) {
      console.log(new Date() + " -> LOG::Info::UserService::checkDoesUserExistWithEmail::databaseSearchResult::Found user with email: " + email + " as user with ID: " + databaseSearchResult.)
