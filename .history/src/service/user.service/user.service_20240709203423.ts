...
export default class UserService {
  ...
  public static async registerUserWithPhoneNumber(
    ...
    if (!PhoneNumberHelper.isPhoneNumberNumericOnly(phoneNumber)) { 
      return new ReturnObjectHandler("Invalid phone number, cannot contain any alphanumeric characters except plus at the start and numbers 0-9")
    }
    try {
      parsedPhoneNumber =
        PhoneNumberHelper.parsePhoneNumberFromString(phoneNumber);
