...
export default class UserService {
  public static async createAndValidateNewUser(
    ...
    username =
      DataSanitazion.sanitizeNONEmailDataWithHTMLAndSpecialCharactersAndWhiteSpacesRemovalAndLowercasing(
        username
      );
    ...
    firstName = DataSanitazion.sanitizeNONEmailDataWithHTMLAndSpecialCharactersAndWhitespacesRemoval(firstName);

    lastName = DataSanitazion.Sa
