...
export default class UserService {
  ...
  public static async checkDoesUserExistWithPhoneNumber(phoneNumber: string) {
    ...
    try {
      ...
      console.log(new Date() + " -> LOG::Error::UserService::checkDoesUserExistWithPhoneNumber::parsedPhoneNumber::TryCatch statement::Error exception: " + error.message + "::Could not parse phone number: " + phoneNumber);
    }
  ...
  public static async registerUserWithPhoneNumber(
    ...
    const isNumberTaken = await this.checkDoesUserExistWithPhoneNumber(
      parsedPhoneNumber
    );
