...
export default class UserService {
  ...
  public static async loginUserWithEmail(
    ...
    if (!doesUserHaveActiveSession) {
      ...
      console.log(new Date() + " -> LOG::Info::UserService::loginUserWithEmail::doesUserHaveActiveSession::No active session was found for user with ID: " + userToLogin.userID + "")
    }
  }
}
