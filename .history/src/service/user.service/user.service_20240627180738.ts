...
export default class UserService {
  public static async createAndValidateNewUser(
    ...
    username = DataSanitazion.sanitizeNonEmailDataWithHTMLAndSpecialCharactersRemoval(username);
    email = DataSanitazion.sanitizeEmail(email);
    password = DataSanitazion.removeAllWhitespaces(password);
    firstName = !firstName
      ? firstName
      : DataSanitazion.sanitizeNonEmailDataWithHTMLAndSpecialCharactersRemoval(firstName);
    lastName = !lastName
      ? lastName
      : DataSanitazion.sanitizeNonEmailDataWithHTMLAndSpecialCharactersRemoval(lastName);
