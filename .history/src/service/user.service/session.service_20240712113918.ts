...
export default class SessionService {
  ...
  public static async extendSessionLifespanByUser(sessionOwnedByUser: User, extendSessionByDateTime: Date = new Date(new Date().getTime() + 24 * 60 * 60 * 1000)) {
    return await SessionService.extendSessionLifespanByUser(sessionOwnedByUser);
  }
}
