...
export default class UserService {
  ...
  public static async checkDoesUserExistWithPhoneNumber_WithParsing(
    ...
    try {
      ...
      console.log(new Date() + " -> LOG::Info::UserService::checkDoesUserExistWithPhoneNumber_WithParsing::parsedPhoneNumber::Parsed phone number with value of: " + JSON.stringify() )
    } catch (error) {
      console.log(
        new Date() +
