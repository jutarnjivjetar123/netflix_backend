...
export default class UserService {
  public static async createAndValidateNewUser(
    ...
    console.log(
      new Date() +
        " -> LOG::Partial Success::UserService::createAndValidateNewUser::userHashCreationInTheDatabaseResult::Created a new hash for user: " + userCreationInTheDatabaseResult.username
    );
