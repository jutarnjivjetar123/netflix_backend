...
export default class UserService {
  ...
  private static async createUserWithPhoneNumber(
    firstName: string = null,
    lastName: string = null,
    username: string = null
  ) {
    const userCreationResult = await 
      UserRepository.createNewUser_DefaultForEmailCreation(
        firstName,
        lastName,
        username,
        false
    ...
    return new ReturnObjectHandler("Created new user with ID: " + (await userCreationResult).returnValue.)
  }
