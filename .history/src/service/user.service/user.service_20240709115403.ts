...
export default class UserService {
  ...
  public static async checkDoesUserExistWithPhoneNumber(phoneNumber: string) {
    ...
    console.log(new Date() + " -> LOG::Info::UserService::checkDoesUserExistWithPhoneNumber::foundUser::Result of database search for user with phone number returned: " + foundUser.)
    if (!foundUser) {
      return new ReturnObjectHandler(
