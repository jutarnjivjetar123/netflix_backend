...
export default class UserService {
  ...
  public static async loginUserWithEmail(
    ...
    if (!(await SessionService.isSessionActiveForUser(userToLogin))) { 
      const sessionDeletionResult = await SessionService.deleteSessionForUser_WithActiveSessionChecking(userToLogin);
      if (!sessionDeletionResult) { 
        return new ReturnObjectHandler("Could not login user")
      }
    }
  }
