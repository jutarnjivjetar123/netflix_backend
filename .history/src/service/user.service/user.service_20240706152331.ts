...
export default class UserService {
  ...
  public static async createNewUserByPhoneNumber(
    ...
    const newPassword = await this.createNewPasswordObjectForUser(password, newUser.returnValue);
    if (!newPassword.returnValue) 
      return new ReturnObjectHandler("Could not create new password for user", )
  }
}
