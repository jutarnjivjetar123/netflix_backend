...
export default class UserService {
  ...
  static async logoutUser(
    ...
    const sessionValidation = await SessionManager.validateSessionBySessionToken(sessionToken);

    if (!sessionValidation) { 
      console.log("LOG::USER SERVICE::logoutUser::Session with token: " + sessionToken + " validation failed")
    }
  }
}
