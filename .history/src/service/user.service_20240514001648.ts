...
export default class UserService {
  ...
  static async logoutUser(
    ...
    const userLogout = await SessionManager.destroySessionBySessionToken(sessionToken);
    if (!userLogout) { 
      console.log("LOG::USER SERVICE::logoutUser::Session with token: " + sessionToken + " couldn't be destroyed");
    }
  }
}
